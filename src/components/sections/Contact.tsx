...
export default function Contact() {
  return (
    ...
    >
      <div className="mx-auto max-w-xl rounded-3xl border border-brand/20 bg-paper p-6 sm:p-10 text-center shadow-[0_8px_32px_-16px_rgba(18,60,64,0.25)]">
        ...
        <h3 className="mt-4 text-lg font-bold text-ink">公式LINEで簡単お問い合わせ</h3>
        ...
        <ol className="mt-8 grid grid-cols-3 gap-3 text-left">
      ...
      <div className="mx-auto mt-6 max-w-xl rounded-2xl border border-border bg-paper p-5">
