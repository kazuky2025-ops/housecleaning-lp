    ...
    <section className="relative overflow-hidden text-paper">
      ...
      <Container className="relative py-16 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-6 whitespace-pre-line font-serif text-3xl sm:text-5xl font-semibold leading-snug tracking-wide">
            {siteConfig.catchCopy}
          </h1>

          <p className="mt-5 whitespace-pre-line text-sm sm:text-base leading-relaxed text-paper/85">
            {siteConfig.subCopy}
          </p>
